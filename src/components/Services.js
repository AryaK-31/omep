...
const Services = () => {
    return (
        <div className="bg-gray-200 services pt-6 font-montserrat">
            ...
            <div data-aos="fade-right"  data-aos-offset="200" data-aos-duration="1000" className="p-6 lg:p-6 works lg:h-3/4 lg:w-3/4 mx-auto mt-12 flex flex-col lg:flex-row justify-between gap-8 items-center">
