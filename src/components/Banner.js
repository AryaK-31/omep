  ...
  return (
    <div className='flex items-center justify-center h-screen bg-fixed bg-center bg-cover custom-img'>
      ...
      <div className='p-5 text-white z-[2] mt-[-10rem]'>
        <div className='p-12'>
          <h1 className='mt-8 text-5xl lg:text-6xl font-banner tracking-wide'>{heading}</h1>
          <p className='py-5 text-xl lg:text-2xl font-tagline'>{message}</p>
          <button className='lg:text-xl px-8 py-2 font-medium font-taglineP border hover:bg-white hover:text-black transition-colors duration-300'>Xplore</button>
        </div>
